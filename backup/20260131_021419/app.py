...
app = Flask(__name__)
app.secret_key = 'chave_secreta_thay_rh' # Mudar para env var em producao

# Configuracao do Banco de Dados
# Tenta pegar do ambiente (Render), senao usa a string direta
...
# Criar tabelas ao iniciar (apenas para este setup inicial simplificado)
...
def atualizar(id):
    ...
    operacao = request.form.get('operacao') # 'entrada' ou 'saida'
